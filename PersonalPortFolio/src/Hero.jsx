        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 text-center text-lg-left">
                    ...
                    <h1 class="text-white text-uppercase fw-bold mb-2" >Jhon</h1>
                    <h1 class="typed-text-output d-inline font-weight-lighter text-white"></h1>
                    <div class="typed-text text-white">Developer</div>
                    <div class="d-flex align-items-center justify-content-center justify-content-lg-start pt-5">
                        <a href="" class="btn btn-danger mr-4">Download CV</a>

                        <a href="" class="btn btn-danger d-none d-sm-block">Play Video</a>
                    </div>
                </div>
